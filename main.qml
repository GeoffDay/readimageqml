...
ApplicationWindow {
    ...
    Row {
        ...
        ComboBox {
            ...
            textRole: "FrameRate"
            model: ListModel {
                ListElement { FrameRate: "Frame Rate 50 fps"; value: 20 }
                ListElement { FrameRate: "Frame Rate 25 fps"; value: 40 }
                ListElement { FrameRate: "Frame Rate 10 fps"; value: 100 }
                ListElement { FrameRate: "Frame Rate 5 fps"; value: 200 }
                ListElement { FrameRate: "Frame Rate 2 fps"; value: 500 }
                ListElement { FrameRate: "Frame Rate 1 fps"; value: 1000 }
            }
